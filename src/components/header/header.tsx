...
export const Header: FC = () => {
  ...
  return (
    ...
    <div className={style.navMenu}>
         <NavLink className={handleActiveNav} to="home">{currentLang.home}</NavLink>
         <NavLink to="about" className={handleActiveNav}>{currentLang.about}</NavLink>
         <NavLink to="" className={handleActiveNav}>{currentLang.services}</NavLink>
         <NavLink to="contact"className={handleActiveNav}>{currentLang.contact}</NavLink>
    </div>
